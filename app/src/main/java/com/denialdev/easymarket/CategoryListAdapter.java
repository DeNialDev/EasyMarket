...
public class CategoryListAdapter extends RecyclerView.Adapter<CategoryListAdapter.MyViewHolder> {
    ...
    private HandlerCategoryClick clickListener;

    public CategoryListAdapter(Context context, HandlerCategoryClick clickListener){
    ...
    public interface HandlerCategoryClick {
